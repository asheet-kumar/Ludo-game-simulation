...
def diceroll(n,c,b,tick,In):
    ...
    while kkk<15 :
        ...
        if In < 15 and n == 1 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img1.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
        ...
        if In < 15 and n == 2 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img2.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
        ...
        if In < 15 and n == 3 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img3.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
        ...
        if In < 15 and n == 4 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img4.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
        ...
        if In < 15 and n == 5 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img5.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
        ...
        if In < 15 and n == 6 and b == 1:
            ...
            In += 1
            if In == 14:
                filename = "images/img6.gif"  # ensure filename is correct
                img = pygame.image.load(filename)
                dispsurf.blit(img, location)
                c.tick(tick)
                b = 0
